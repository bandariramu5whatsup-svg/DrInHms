...
namespace HanuMediSoftCore.Services.Hms.Op.Masters
{
    public class UnitsService
    {
        ...
        public UnitsService(DatabaseHelper db)
        {
            _db = db;
        }

        public List<Dictionary<string, object?>> GetUnits(Unit model)
        {
            ...
            // Using helper class
            DataTable dt = _db.ExecuteSP(UnitsProcedures.Get, parameters);
            var list = _db.ToList(dt);
            return list;
        }

        public List<Dictionary<string, object?>> SaveUnits(Unit model)
        {
            var parameters = new Dictionary<string, object?>
                    {
                        { "@UnitId", model.UnitId },
            ...
            // Using helper class
            DataTable dt = _db.ExecuteSP(UnitsProcedures.Save, parameters);
            var list = _db.ToList(dt);
            return list;
        }
    }
